...
class ClinicalReportGenerator(FPDF):
    ...
    """
    def __init__(self, logo_path="app/assets/logo.png", audit_hash=None, version="2.4.0"):
        super().__init__()
    ...
    def footer(self):
        ...
        self.cell(0, 8, f'Page {self.page_no()} | Generated by CardioSense Distributed Intelligence v{self.version}', align='C')
