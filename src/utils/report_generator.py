...
class ClinicalReportGenerator(FPDF):
    ...
    def header(self):
        ...
        self.set_xy(35, 10)
        self.cell(0, 10, 'CardioSense AI', ln=True)
        
        self.set_font('helvetica', 'B', 9)
        self.set_xy(35, 20)
        self.cell(0, 8, 'CLINICAL DECISION SUPPORT - RISK STRATIFICATION REPORT', ln=True)
    ...
    def footer(self):
        ...
        self.cell(0, 5, confidential, ln=True, align='C')
    ...
    def add_demographics(self):
        ...
        self.cell(0, 10, "PATIENT & CLINICAL CONTEXT", ln=True)
        self.ln(2)
        ...
        self.set_font('helvetica', '', 10)
        self.cell(50, 7, "System Automated Audit", ln=True)
    ...
    def add_executive_summary(self, prediction, probability, reasoning, overrides, confidence=None):
        ...
        self.cell(100, 10, f"Status: {status}", ln=True)
